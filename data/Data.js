...
const allFaqData = [
  {
    id: 0,
    color: "orange",
    title: "What age groups does East Asian International School accept?",
    desc: "East Asian International School welcomes students from Early Childhood (ages 3–5) through to Senior Secondary (ages 15–18). Our programmes are thoughtfully designed to nurture each stage of a child's development, from play-based learning in the early years to rigorous academic preparation in senior school.",
  },
  {
    id: 1,
    color: "green",
    title: "What curriculum does the school follow?",
    desc: "We offer an internationally recognised curriculum that blends strong academic foundations with East Asian educational values. Our programmes include Early Childhood Education, Primary Years, and Secondary levels, incorporating languages (English, Mandarin, and Japanese), STEM, arts, and physical education.",
  },
  {
    id: 2,
    color: "red",
    title: "How do I apply for admission to East Asian International School?",
    desc: "Admission is open year-round subject to availability. Parents can submit an online application through our website, attaching recent academic records and a passport photo. Our admissions team will contact you within 3 working days to arrange an assessment and school tour.",
  },
  {
    id: 3,
    color: "blue",
    title: "Does the school provide transport and boarding facilities?",
    desc: "Yes. We operate a fleet of GPS-monitored school buses covering major routes in the city. For international families, we offer boarding facilities with 24-hour pastoral care, supervised study time, and a range of co-curricular activities to ensure a safe and enriching environment for students living on campus.",
  },
  {
    id: 4,
    color: "orange",
    title: "What extracurricular activities are available for students?",
    desc: "Students can participate in a wide range of activities including football, swimming, badminton, martial arts, robotics, drama, choir, calligraphy, and cultural clubs. We believe a well-rounded childhood is built inside and outside the classroom, and our after-school programme reflects this philosophy.",
  },
  {
    id: 5,
    color: "green",
    title: "How does the school support students' well-being and mental health?",
    desc: "Our dedicated pastoral care team, school counsellors, and class teachers work collaboratively to monitor every student's emotional and social well-being. We hold regular well-being assemblies, mindfulness sessions, and parent workshops to ensure students feel safe, valued, and supported throughout their school years.",
  },
  {
    id: 6,
    color: "blue",
    title: "Are scholarships or fee assistance available?",
    desc: "East Asian International School offers merit-based scholarships for outstanding students at the secondary level, as well as need-based fee assistance for families who qualify. Please contact our finance office or download the scholarship application form from our website for details on eligibility and deadlines.",
  },
  {
    id: 7,
    color: "orange",
    title: "How can parents stay involved in school life?",
    desc: "We strongly encourage parental engagement. Parents can join our Parent-Teacher Association (PTA), attend termly parent-teacher conferences, volunteer at school events, and access real-time academic updates through our secure parent portal. Open communication between home and school is central to our approach.",
  },
];
